    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20'>
                ...
                <p>
                    At Homelinen and Living, we are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner.
                </p>
                ...
                <p className='mt-3'>
                    Thank you for trusting Homelinen and Living. Your privacy is important to us.
                </p>
            </div>
        </div>
    )
